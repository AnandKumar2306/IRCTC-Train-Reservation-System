/*The Problem is based on the train reservation system. The system displays its features –
1.	View Train List
2.	Book Tickets
3.	Cancel Booking
4.	Train Status Board
5.	Exit
When the user enters its choice the respective operation is performed. When user enters 1 train list is displayed. When 2 is entered and the name and seat number is entered the seat is booked .When 3 is entered along with train number and seat number the seat booked is cancelled and the amount is refunded. When 4 is entered by the user along with train number the status of the train is displayed which seat is empty and which is booked. When 5 is entered the program ends and the message is displayed Thank you for using this system.*/

#include <stdio.h>
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"Rajdhani Express","RaptiSagar Superfast Express","Shatabdi Express","Tejas Express","Vande Bharat Express","Humsafar Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
int main()
{
    ...
    do{
    printf("\n\n\n");
   printf("====================================== WELCOME TO IRCTC TRAIN RESERVATION SYSTEM ======================================\n\n\n");
    printf("\t\t\t\t\t[1]=> View Train List\n");
    printf("\n");
...
{
    printf("\n\n\n");
    printf("=========================================== IRCTC TRAIN RESERVATION SYSTEM ============================================\n\n\n");
    printf("\t\t\t\t\t[1]  =>  %s\n",ch[0]);
    printf("\n");
    printf("\t\t\t\t\t[2]  =>  %s\n",ch[1]);
    printf("\n"); 
